...
#   Author: Bani99 <kill@Japanese.com>                                                                                                #
#   Thanks: @Bani99 <https://file.bani99.com/scripts>                                                                            #
#   Intro:  https://file.bani99.com/scripts/shadowsocks/                                                                           #
#=================================================================#
...
echo "# Intro: https://file.bani99.com/scripts/shadowsocks/                                                   #"
echo "# Author:  Bani99 <admin@bani99.com>                                                          #"
echo "# Github: https://github.com/shadowsocks/rely/shadowsocks                           #"
echo "#############################################################"
echo

libsodium_file="libsodium-1.0.17"
libsodium_url="https://file.bani99.com/scripts/shadowsocks/rely/libsodium-1.0.17.tar.gz"
...
pre_install(){
    ...
    read -p "(Default password: bani99.com):" shadowsockspwd
    [ -z "${shadowsockspwd}" ] && shadowsockspwd="bani99.com"
    echo
    echo "---------------------------"
...
download_files(){
    ...
    if ! wget --no-check-certificate -O shadowsocks-master.zip https://file.bani99.com/scripts/shadowsocks/rely/shadowsocks-master.zip; then
        echo -e "[${red}Error${plain}] Failed to download shadowsocks python file!"
        exit 1
    fi
    # Download Shadowsocks init script
    if check_sys packageManager yum; then
        if ! wget --no-check-certificate https://file.bani99.com/scripts/shadowsocks/rely/shadowsocks -O /etc/init.d/shadowsocks; then
            echo -e "[${red}Error${plain}] Failed to download shadowsocks chkconfig file!"
            exit 1
        fi
    elif check_sys packageManager apt; then
        if ! wget --no-check-certificate https://file.bani99.com/scripts/shadowsocks/rely/shadowsocks-debian -O /etc/init.d/shadowsocks; then
            echo -e "[${red}Error${plain}] Failed to download shadowsocks chkconfig file!"
            exit 1
        fi
    fi
...
install(){
    ...
    if [ -f /usr/bin/ssserver ] || [ -f /usr/local/bin/ssserver ]; then
        ...
        echo
        echo -e "[${red}Error${plain}] Shadowsocks install failed! please visit https://killjapanese.com/ss.html and contact."
        install_cleanup
        exit 1
    fi
    ...
    echo
    echo "Welcome to visit:https://file.bani99.com/scripts/shadowsocks/"
    echo "Enjoy it!"
    echo
}
